export default function ChatShell({ header, children, footer }) {
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-1 flex-col overflow-hidden rounded-[36px] border border-white/60 bg-[var(--panel)] shadow-glow backdrop-blur min-h-[calc(100vh-6rem)] max-h-[calc(100vh-6rem)]">
